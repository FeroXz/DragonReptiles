...
- [x] Startseiten-Hero mit gestapelten Kennzahlen, CTA-Gradienten und sekundärer Copy für mehr Orientierung komplett neu gestaltet (Version 5.6.1).
- [x] Hauptmenü als gläserne Capsule-Navigation mit Utility-Links, Dropdown-State und abgestuften CTA-Buttons neu aufgebaut (Version 5.6.2).
- [x] Vollflächiges Overlay-Menü nach HTML5UP-Landing-Vorbild mit mittiger Typografie, Unterpunkten und CTA-Stapel umgesetzt (Version 5.6.3).
