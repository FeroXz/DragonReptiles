...
- [x] Genetik-Rechner-Karten zeigen grüne Eltern-Badges, gelbe Suchfelder und labelartige Vorschlagslisten für eine klar erkennbare Eingabe (Version 5.6.1).
- [x] Genetik-Suche mit klaren Label-Vorschlägen, farbcodierten Trait-Tags und reduziertem Suchfeld ohne übergroßes Icon (Version 5.6.2).
