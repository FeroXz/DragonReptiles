<nav class="admin-nav nui-panel nui-panel--floating" aria-label="Admin-Navigation">
    <a href="<?= BASE_URL ?>/index.php?route=admin/dashboard" class="admin-nav__link nui-pill <?= $currentRoute === 'admin/dashboard' ? 'is-active' : '' ?>">
    ...
    <a href="<?= BASE_URL ?>/index.php?route=admin/animals" class="admin-nav__link nui-pill <?= $currentRoute === 'admin/animals' ? 'is-active' : '' ?>">
        <span class="admin-nav__icon" aria-hidden="true">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" class="h-5 w-5">
    ...
    <?php if (is_authorized('can_manage_animals')): ?>
        <a href="<?= BASE_URL ?>/index.php?route=admin/breeding" class="admin-nav__link nui-pill <?= $currentRoute === 'admin/breeding' ? 'is-active' : '' ?>">
            <span class="admin-nav__icon" aria-hidden="true">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" class="h-5 w-5">
    ...
    <?php endif; ?>
    <a href="<?= BASE_URL ?>/index.php?route=admin/adoption" class="admin-nav__link nui-pill <?= $currentRoute === 'admin/adoption' ? 'is-active' : '' ?>">
        <span class="admin-nav__icon" aria-hidden="true">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" class="h-5 w-5">
    ...
    <a href="<?= BASE_URL ?>/index.php?route=admin/inquiries" class="admin-nav__link nui-pill <?= $currentRoute === 'admin/inquiries' ? 'is-active' : '' ?>">
        <span class="admin-nav__icon" aria-hidden="true">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" class="h-5 w-5">
    ...
    <?php if (is_authorized('can_manage_settings')): ?>
        <a href="<?= BASE_URL ?>/index.php?route=admin/pages" class="admin-nav__link nui-pill <?= $currentRoute === 'admin/pages' ? 'is-active' : '' ?>">
            <span class="admin-nav__icon" aria-hidden="true">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" class="h-5 w-5">
        ...
        <a href="<?= BASE_URL ?>/index.php?route=admin/news" class="admin-nav__link nui-pill <?= $currentRoute === 'admin/news' ? 'is-active' : '' ?>">
            <span class="admin-nav__icon" aria-hidden="true">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" class="h-5 w-5">
                    <path d="M4 5h16" />
                    <path d="M4 11h16" />
        ...
        <a href="<?= BASE_URL ?>/index.php?route=admin/care" class="admin-nav__link nui-pill <?= $currentRoute === 'admin/care' ? 'is-active' : '' ?>">
            <span class="admin-nav__icon" aria-hidden="true">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" class="h-5 w-5">
        ...
        <a href="<?= BASE_URL ?>/index.php?route=admin/gallery" class="admin-nav__link nui-pill <?= $currentRoute === 'admin/gallery' ? 'is-active' : '' ?>">
            <span class="admin-nav__icon" aria-hidden="true">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" class="h-5 w-5">
                    <rect x="3" y="5" width="18" height="14" rx="2" />
        ...
        <a href="<?= BASE_URL ?>/index.php?route=admin/home-layout" class="admin-nav__link nui-pill <?= $currentRoute === 'admin/home-layout' ? 'is-active' : '' ?>">
            <span class="admin-nav__icon" aria-hidden="true">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" class="h-5 w-5">
                    <path d="M4 6h16" />
                    <path d="M4 12h10" />
        ...
        <a href="<?= BASE_URL ?>/index.php?route=admin/settings" class="admin-nav__link nui-pill <?= $currentRoute === 'admin/settings' ? 'is-active' : '' ?>">
            <span class="admin-nav__icon" aria-hidden="true">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" class="h-5 w-5">
        ...
        <a href="<?= BASE_URL ?>/index.php?route=admin/content" class="admin-nav__link nui-pill <?= $currentRoute === 'admin/content' ? 'is-active' : '' ?>">
            <span class="admin-nav__icon" aria-hidden="true">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" class="h-5 w-5">
        ...
        <a href="<?= BASE_URL ?>/index.php?route=admin/update" class="admin-nav__link nui-pill <?= $currentRoute === 'admin/update' ? 'is-active' : '' ?>">
            <span class="admin-nav__icon" aria-hidden="true">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" class="h-5 w-5">
                    <path d="M4 4v6h6" />
                    <path d="M20 20v-6h-6" />
    ...
    <?php if (current_user()['role'] === 'admin'): ?>
        <a href="<?= BASE_URL ?>/index.php?route=admin/users" class="admin-nav__link nui-pill <?= $currentRoute === 'admin/users' ? 'is-active' : '' ?>">
            <span class="admin-nav__icon" aria-hidden="true">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" class="h-5 w-5">
