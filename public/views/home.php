...
<section class="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
    <div class="grid gap-10 rounded-3xl border border-white/5 bg-night-900/70 p-8 shadow-glow shadow-brand-600/20 lg:grid-cols-2 nui-panel nui-panel--floating">
        <div class="space-y-6">
