...
(() => {
  ...
  function GenotypeSearch({ species, value, onChange, presets }) {
    ...
    const optionAccentClass = (0, import_react.useCallback)(
      (entry) => {
        if (entry.kind === "preset") {
            ...
            grouped.map((entry) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "nui-dropdown__group", children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", { children: entry.options.map((option) => {
                ...
                return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                  ...
                  {
                    type: "button",
                    className: clsx_default("nui-option", optionAccentClass(option), {
                      "is-active": isActive,
                    ...
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { className: "nui-option__pill", children: [
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "nui-option__dot", "aria-hidden": "true" }),
  ...
  var genetics_de_default = {
    reset: "Zur\xFCcksetzen",
    calculate: "Kombination berechnen",
    parentA: "Tier A",
    parentB: "Tier B",
    normal: "Normal",
    het: "het",
    expressed: "Ausgepr\xE4gt",
    super: "Super",
    present: "Vorhanden",
    posHet: "pos. het",
    ...
    notCalculated: "Lege zun\xE4chst Genetik f\xFCr beide Tiere fest und starte die Berechnung.",
    ...
    species: {
      hognose: {
        ...
        subtitle: "Heterodon nasicus"
      },
      pogona: {
        label: "Bartagame",
        subtitle: "Pogona vitticeps"
      }
    }
  };
  ...
  function Calculator() {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "genetics-calculator", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("section", { className: "genetics-calculator__inputs", children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "search-panel nui-card nui-card--glass search-panel--a", children: [
          /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "search-panel__header", children: [
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "search-panel__badge search-panel__badge--parent", "aria-label": messages.parentA, children: messages.parentA }),
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "search-panel__badge search-panel__badge--species", "aria-label": activeSpecies.label, children: activeSpecies.label })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "search-panel__field", "aria-label": `${messages.parentA} \xB7 ${activeSpecies.label}`, children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(GenotypeSearch, { species: speciesKey, value: parentA, onChange: setParentA }) })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "search-panel nui-card nui-card--glass search-panel--b", children: [
          /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "search-panel__header", children: [
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "search-panel__badge search-panel__badge--parent", "aria-label": messages.parentB, children: messages.parentB }),
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "search-panel__badge search-panel__badge--species", "aria-label": activeSpecies.label, children: activeSpecies.label })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "search-panel__field", "aria-label": `${messages.parentB} \xB7 ${activeSpecies.label}`, children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(GenotypeSearch, { species: speciesKey, value: parentB, onChange: setParentB }) })
        ] })
      ] }),
  ...
  var container = document.querySelector("[data-genetics-root]");
  if (container && !window.__GENETICS_APP_MOUNTED__) {
    const root = (0, import_client.createRoot)(container);
    root.render(
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_react4.StrictMode, { children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Calculator, {}) })
    );
